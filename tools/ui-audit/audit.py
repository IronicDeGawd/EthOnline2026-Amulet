...
ITEMS = [
    ...
    ("SWAP", "title", "manrope_700_15", 36, None, 240, "CLIP", ["Swap"]),
    ("SWAP", "row 1 side", "manrope_500_13", 76, 46, 60, "LEFT", ["From"]),
    ("SWAP", "row 1 token", "manrope_700_15", 76, 130, 64, "LEFT", ["USDC", "ETH"]),
    ("SWAP", "row 2 side", "manrope_500_13", 118, 46, 60, "LEFT", ["To"]),
    ("SWAP", "row 2 token", "manrope_700_15", 118, 130, 64, "LEFT", ["USDC", "ETH"]),
    ("SWAP", "go label", "manrope_700_15", 168, 58, 124, "LEFT", ["Find a route"]),
    ("SWAP", "note", "manrope_500_11", 200, None, 240, "CLIP", ["swipe down for home", "Asking the agent...", "pick two different", "no link to the agent"]),
