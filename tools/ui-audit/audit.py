...
ITEMS = [
    ...
    ("SWAP", "title", "manrope_700_15", 44, None, 240, "CLIP", ["Swap"]),
    ("SWAP", "row 1 side", "manrope_500_13", 84, 46, 60, "LEFT", ["From"]),
    ("SWAP", "row 1 token", "manrope_700_15", 84, 130, 64, "LEFT", ["USDC", "ETH"]),
    ("SWAP", "row 2 side", "manrope_500_13", 128, 46, 60, "LEFT", ["To"]),
    ("SWAP", "row 2 token", "manrope_700_15", 128, 130, 64, "LEFT", ["USDC", "ETH"]),
    ("SWAP", "go label", "manrope_700_15", 166, 58, 124, "LEFT", ["Find a route"]),
